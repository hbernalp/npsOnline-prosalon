<script>
    ...
    function add() {
        ...
        el2.innerHTML = '<label><span>Tienda Cromantic</span><span class="hs-form-required">*</span></label><div class="input"><select disabled="disabled"><option value="" disabled="" selected="">Escoge una ciudad</option></select></div>'
        ...
        document.getElementsByClassName('hs_cromantic_feedback_ciudad')[0].parentElement.appendChild(el2);
 ...
 */
    ...
    function funcionalidad() {
        ...
        $(document).on('input propertychange paste', ".hs_cromantic_feedback_text2 textarea, .hs_cromantic_feedback_text1 textarea, .hs_cromantic_feedback_text3 textarea", function () {
        ...
        var section2 = $(".hs-richtext, .hs_cromantic_feedback_ciudad, .hs_cromantic_feedback_ciudad + div, .hs_firstname, .hs_email, .hs_cromantic_documento, .hs_cromantic_telefono, .hs_cromantic_habeas_data, .hs_submit");
        ...
        $(document).on('change', '.hs_cromantic_feedback_ciudad select', function () {
