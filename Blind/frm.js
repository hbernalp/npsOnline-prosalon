<script>
    ...
    function add() {
        ...
        document.getElementsByClassName('hs_blind_online_canal_de_compra')[0].parentElement.appendChild(el2);
 ...
 */
    ...
    function funcionalidad() {
        ...
        var section2 = $(".hs-richtext, .hs_blind_online_canal_de_compra, .hs_blind_online_canal_de_compra + div, .hs_firstname, .hs_email, .hs_blind_documento, .hs_blind_telefono, .hs_blind_habeas_data, .hs_submit");
